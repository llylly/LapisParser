...
enum RUNTIME_ERROR_TYPE {
    ...
    API_NOT_FOUND, API_NOT_PARSED, REQUESTER_INIT_ERR, SCENARIO_CONFIG_NOT_PARSED,
    SET_EMPTY_TERMINATE, CHECKPOINT_NOT_PASS_TERMINATE, END_MODULE_TERMINATE, NO_WAY_TERMINATE,
    LENGTH_EXCEED_TERMINATE, ILLEGAL_SET_EFFECT
};
