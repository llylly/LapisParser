...
enum ERROR_TYPE {
    ...
    SCENARIO_INITIAL_STATE_ERROR, SCENARIO_START_MODULE_ERROR, INVALID_API_REFERENCE, INVALID_RESPONSE_TYPE,
    INVALID_EXPRESSION, INVALID_SET, INVALID_STATE, INVALID_MODULE, DUPLICATE_TEST_CONFIG,
    NOT_CONFIG_PARSED, INVALID_SCENARIO
};
